...
if __name__ == '__main__':
    file_path = "/1T/liufangtao/datas/galss_quanmian/q0913T/images"
    xmlpath= '/1T/liufangtao/datas/galss_quanmian/q0913T/labels'
    new_file_path = "/1T/liufangtao/datas/galss_quanmian/q0913T/train_val"
    split_data(file_path,new_file_path,train_rate=0.50,val_rate=0.5,test_rate=0.0)
